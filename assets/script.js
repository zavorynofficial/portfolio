(() => {
  ...
  document.addEventListener('DOMContentLoaded',()=>{injectStyle('zavoryn-quality-css','assets/brand-upgrades.css?v=20260925-audit4');injectStyle('zavoryn-global-css','assets/zavoryn-global.css?v=20260925-audit4');universalNav();universalFooter();a11y();makeLightbox();initNav();initHeader();initTracking();injectCardGraphics();initGoals();initFeatured();initGalleryPages();observe();const loader=document.createElement('script');loader.src='assets/production-upgrade.js';loader.async=true;document.head.appendChild(loader)});
